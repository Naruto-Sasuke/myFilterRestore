...
I = [];  %滤镜图
Ori = im2double(imread('vcnn/applications/filterRestore/images/lena.jpg')); %原图
model_path = [];
%除了锐化效果的还原外，其他效果的还原都要加上锐化后续操作
if strcmp(filterType,'rh')
    I = im2double(imread('vcnn/applications/filterRestore/images/lena-rh.jpg'));
    model_path = 'vcnn/applications/filterRestore/models/rh.mat';
%    beta = 2.388608e+00 / 2;  PSNR = 28
%    beta = ...........+01/2;  PSNR = 25
%    beta = 2.388608e+02 / 2;  PSNR = 24  越来越模糊了。。
     beta = 1.388608e+00 / 2;
elseif strcmp(filterType,'zuanqiang')
    I = im2double(imread('vcnn/applications/filterRestore/images/lena-zuanqiang.jpg'));
    model_path = 'vcnn/applications/filterRestore/models/zuanqiang.mat';
    beta = 2.388608e+02 / 2;
...
elseif strcmp(filterType,'dssmx')
    I = im2double(imread('vcnn/applications/filterRestore/images/lena-dssmx.jpg'));
    model_path = 'vcnn/applications/filterRestore/models/dssmx.mat';
    beta = 2.388608e+02 / 2;
elseif strcmp(filterType,'GuassBlur')
    I = im2double(imread('vcnn/applications/filterRestore/images/lena-GuassBlur.jpg'));
    model_path = 'vcnn/applications/filterRestore/models/GuassBlur.mat';
    beta =  6.388608e+00 / 2;
else     %以后加入新的效果
